...
public class TaskSchedulerTools(TaskSchedulerService scheduler, ProjectConfig config)
{
    ...
    [McpServerTool, Description(
        ...
        "参数 resumeCondition：恢复条件（例如：Core/.dna/identity.md ## Contract 包含 IEventBus）。" +
    ...
    public string suspend_and_push(
        ...
        [Description("恢复条件，例如：Core/.dna/identity.md ## Contract 包含 IEventBus")] string resumeCondition,
