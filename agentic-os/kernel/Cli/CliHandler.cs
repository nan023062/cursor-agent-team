    ...
    ProjectConfig config)
{
    ...
    private int RunContext(string[] args)
    {
        ...
        PrintDnaFileStatus("identity.md", module.IdentityPath);
        PrintDnaFileStatus("lessons.md", module.LessonsPath);
        PrintDnaFileStatus("links.md", module.LinksPath);
        PrintDnaFileStatus("history.md", module.HistoryPath);
        PrintDnaFileStatus("active.md", module.ActivePath);
